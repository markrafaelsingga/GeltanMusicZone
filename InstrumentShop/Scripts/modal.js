...
function openStaffEditModal(suppid,company, fname, mi, lname, phone, address, email) {
    document.getElementById('editSupModal').innerHTML = `
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input type="text" id="company" name="company" class="textbox-style" style="width: 300px !important;" value="${company}" required autofocus  oninput="updateModalContent('fname', this.value)" />
            </div>
            <div class="form-group">
                <label for="fname">Firstname:</label>
                <input type="text" id="fname" name="fname" class="textbox-style" style="width: 300px !important;" value="${fname}" required autofocus  oninput="updateModalContent('fname', this.value)" />
            ...
            <div class="form-group">
                <button type="button" onclick="editStaff('${suppid}')">Submit</button>
            </div>
